-- ### TO DO: Implement following filters
-- ### gaps_too_large: off anyone with gaps too wide < X days. How many days is too wide????
-- ### spread_of_calls_in_day: keep only people whose calls are spread out throughout the 12 waking hours 
-- ### (ex: not 5 calls in a row if only 5 calls made in a day)
-- ### user_not_tourist: Filter out anyone with days active > 20 days 
