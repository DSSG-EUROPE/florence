...
export default class MuseumFountain extends Component {
  ...
  constructor(props) {
    ...
    requestJson(props.dataUrl, (error, response) => {
      const item = response.features.find(f => {
  ...
  render() {
    const {viewport, data, selectedItem} = this.state;
